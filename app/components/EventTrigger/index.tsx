      ...
      return (
        <div className="my-2">
          <EventContextMenu event={toast} setToasts={setToasts}>
            <div
              className={`py-2 px-4 rounded-xl bg-gradient-to-br from-zinc-50 via-zinc-50 to-blue-50/75 border border-zinc-200 min-w-[20rem] shadow-sm animate-in fade-in slide-in-from-top duration-700 ${
            ...
            >
              <div className="flex w-full justify-between items-center">
                <div className="flex gap-x-2 items-center">
                  {toast?.emoji ?? (
                    <div className="h-3 w-3 rounded-full bg-blue-500 text-white flex justify-center items-center shadow-sm shadow-blue-500" />
                  )}
          ...
          <EventContextMenu event={toast} setToasts={setToasts}>
            ...
            >
              <div className="flex w-full justify-between items-center">
                <div className="flex gap-x-2 items-center">
                  {toast?.emoji ?? (
                    <div className="h-3 w-3 rounded-full bg-red-500 text-white flex justify-center items-center shadow-sm shadow-red-500" />
                  )}
          ...
          <EventContextMenu event={toast} setToasts={setToasts}>
            ...
            >
              <div className="flex w-full justify-between items-center">
                <div className="flex gap-x-2 items-center">
                  {toast?.emoji ?? (
                    <div className="h-3 w-3 rounded-full bg-yellow-500 text-white flex justify-center items-center shadow-sm shadow-yellow-500" />
                  )}
            ...
            >
              <div className="flex justify-between items-center">
                <div className="flex gap-x-2 items-center">
                  ...
                  <Chip className="rounded-lg text-xs p-px">via webhook</Chip>
                </div>
            ...
            >
              <div className="flex justify-between">
                <div className="flex gap-x-2 items-center">
                  ...
                  {isStatic ? (
                    <h3 className="bg-transparent outline-none text-black w-full truncate">
                      {toast.text}
                    </h3>
                  ) : (
                    <TextWrapper
